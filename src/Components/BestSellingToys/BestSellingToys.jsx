    ...
    return (
        <div className='text-center mb-20 bg-orange-50 p-4 pb-10 mt-10'>
            ...
            <div className='md:flex justify-evenly mt-10'>
                <div className="card card-compact md:w-60 shadow-xl mb-3">
            ...
            <Link to='/alltoys'><button className=' mt-5 mb-42 btn bg-red-600 border-none'>View All Toys</button></Link>
        </div>
    );
};
